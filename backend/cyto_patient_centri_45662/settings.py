"""
Django settings for cyto_patient_centri_45662 project.
...
ROOT_URLCONF = 'cyto_patient_centri_45662.urls'
...
WSGI_APPLICATION = 'cyto_patient_centri_45662.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cyto_patient_centri_45662 API",
    "DESCRIPTION": "API documentation for cyto_patient_centri_45662 App",
    "VERSION": "v1",
}
